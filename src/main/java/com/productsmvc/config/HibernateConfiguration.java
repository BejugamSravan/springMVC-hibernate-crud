...
@ComponentScan({ "com.productsmvc.config" })
@PropertySource(value = { "classpath:databaseproperties" })
public class HibernateConfiguration {
 ...
 private static final Logger logger = LoggerFactory.getLogger(HibernateConfiguration.class);
    ...
    public LocalSessionFactoryBean sessionFactory() throws PropertyVetoException {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.productsmvc.model" });
